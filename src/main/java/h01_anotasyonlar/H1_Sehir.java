...
@Entity   //alttaki class ismiyle table olusturuyor.
@Table(name="Sehir_Tablosu") //zorunda degiliz, sql deki tablo ismini degistirmis olurum
public class H1_Sehir {

	@Id                                                  // bu sütun primary key=not null ve unique olacak.
	@Column(name="sehir_plaka")     //sütunun sql deki ismini degistirdik
	private int sehirPlaka;
	
	private String sehirAdi;
	private int sehirNufus;
	
	@Transient            //burayi sqlde sütun olarak eklemez.. Javada kullanabiliriz ama SQLdeki tabloda görünmez..
