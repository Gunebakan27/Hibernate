...
public class H4_Fetch {
	...
	public static void main(String[] args) {
		...
		//id=111 olan ögrenciyi getir
		
		System.out.println(session1.get(H1_Ogrenci.class,111));
		
		// id=222 olan ögrenciyi getir
		System.out.println(session1.get(H1_Ogrenci.class,222));
...
tx1 = session1.beginTransaction();	
		...
		// Ayrı bir sessionda aynı veriye (111) erişmek istersek ne olur?
				...
				System.out.println(session2.get(H1_Ogrenci.class,111));
				System.out.println(session2.get(H1_Ogrenci.class,222));
